...
namespace FondOfSpryker\Zed\AllowedProductQuantityGui\Communication\FormExpander;
...
{
    /**
     * @var \FondOfSpryker\Zed\AllowedProductQuantityGui\Communication\Form\AllowedQuantityForm
     */
    protected $allowedQuantityForm;

    /**
     * @var \FondOfSpryker\Zed\AllowedProductQuantityGui\Communication\Form\DataProvider\AllowedQuantityFormDataProvider
     */
    protected $allowedQuantityFormDataProvider;

    /**
     * @param \FondOfSpryker\Zed\AllowedProductQuantityGui\Communication\Form\AllowedQuantityForm $allowedQuantityForm
     * @param \FondOfSpryker\Zed\AllowedProductQuantityGui\Communication\Form\DataProvider\AllowedQuantityFormDataProvider $allowedQuantityFormDataProvider
     */
